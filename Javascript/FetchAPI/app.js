...
//http.get('https://jsonplaceholder.typicode.com/post').then(data=>console.log(data)).catch(err=>console.log(err))
...
//http.delete('https://jsonplaceholder.typicode.com/posts/1', data).then(data=>console.log(data)).catch(err=>console.log(err))
